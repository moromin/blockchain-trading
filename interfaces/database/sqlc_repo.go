...
func (q *Queries) GetCurrency(ctx context.Context, coin string) (entity.Currency, error) {
	row := q.Db.QueryRowContext(ctx, getCurrency, coin)
...
func (q *Queries) ListCurrencies(ctx context.Context, arg usecase.ListCurrenciesParams) ([]entity.Currency, error) {
...
func (q *Queries) ResisterCurrency(ctx context.Context, arg usecase.ResisterCurrencyParams) (entity.Currency, error) {
